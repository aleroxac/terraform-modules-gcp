...
This example demonstrates how to use the `project-service` module to create a single `project-service` on Google Cloud with the minimum required configuration. 
...
* This example creates only the `project-service`;
