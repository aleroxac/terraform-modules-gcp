...
This example demonstrates how to use the `subnet` module to create a single `subnet` on Google Cloud with the minimum required configuration. 
...
* This example creates only the `subnet`; other networking components must be created using their respective modules.
